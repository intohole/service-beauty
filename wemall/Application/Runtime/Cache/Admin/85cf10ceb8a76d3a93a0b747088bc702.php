...
<html lang="cn">
	<head>
		...
		<!--[if lte IE 8]>
		  <link rel="stylesheet" href="/Public/Plugin/style/css/ace-ie.min.css" />
		<![endif]-->
		...
		<!--[if lt IE 9]>
		<script src="/Public/Plugin/style/js/html5shiv.js"></script>
		<script src="/Public/Plugin/style/js/respond.min.js"></script>
		<![endif]-->
		...
		<!--[if IE]>
		<script type="text/javascript">
		 	window.jQuery || document.write("<script src='/Public/Plugin/style/js/jquery-1.10.2.min.js'>"+"<"+"/script>");
		</script>
		<![endif]-->
		...
		<!--[if lte IE 8]>
		  <script src="/Public/Plugin/style/js/excanvas.min.js"></script>
		<![endif]-->
	...
	<body>
<script type="text/javascript">
var UEURL = '/Public/Plugin/umeditor/';
</script>
<link href="/Public/Plugin/umeditor/themes/default/css/umeditor.css" type="text/css" rel="stylesheet">
<script type="text/javascript" src="/Public/Plugin/umeditor/third-party/jquery.min.js"></script>
<script type="text/javascript" charset="utf-8" src="/Public/Plugin/umeditor/umeditor.config.js"></script>
<script type="text/javascript" charset="utf-8" src="/Public/Plugin/umeditor/umeditor.min.js"></script>
<script type="text/javascript" src="/Public/Plugin/umeditor/lang/zh-cn/zh-cn.js"></script>
			...
			function reGood(o) {
				...
				$.post("<?php echo U('Admin/Good/getgoodid');?>",{"id":goodid},function(data){
					...
					if (flag) {
						...
						$('input[name="addimage"]').parent().append('<img src="/Public'+json.savepath+json.image+'" id="goodimage" style="max-width:650px" class="img-thumbnail">');
						flag = false;
					}else{
						$('input[name="goodid"]').val(json.id);
						$('#goodimage').attr("src","/Public"+json.savepath+json.image);
					}
				});
