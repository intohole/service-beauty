<?php
define ('BACK_AUTH_NAME','backadminreleaseauthv10');
class Session_AdminRelease { 
	...
	private $login_url = 'http://release.yinbake.com/login';

	public $domain = 'release.yinbake.com';
	...
	static public function instance(){
		if(self::$obj)
			...
			self::$obj = new Session_AdminRelease();
		}
		return self::$obj;
	}
