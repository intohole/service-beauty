...
if (!defined('TK_DATA_PATH')) {
    define('TK_DATA_PATH', APP_PATH.'/Runtime/Data/');
    define('TK_DB_FIELDS_CACHE', C('DB_FIELDS_CACHE')?TRUE:(C('website.isOnline')?TRUE:FALSE));  //字段是否缓存 如果配置不在线或者线上环境 则缓存
    //define('TK_DB_FIELDS_CACHE', TRUE);
...
class TK_M {
    ...
    public function db($linkNum='',$config='',$force=false) {
        ...
        if(!isset($this->_db[$linkNum]) || $force ) {
            ...
            $this->_db[$linkNum]            =    TK_Db::getInstance($config);
        }elseif(NULL === $config){
