FROM URL: https://github.com/coen-hyde/Shanty-Mongo/blob/master/README.markdown
...
In the above User, Student and SchoolCaptain will be saved in the user collection. Even though it looks like the requirements in User are being over-ridden by the requirements in Student and SchoolCaptain 