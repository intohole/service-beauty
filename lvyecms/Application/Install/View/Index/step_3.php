...
<div class="wrap">
  ...
  <section class="section">
    ...
    <form id="J_install_form" action="{:U('step_4')}" method="post">
      ...
      <div class="server">
        <table width="100%">
          ...
          <tr>
            ...
            <td><input type="text" name="dbname" id="dbname" value="lvyecms" class="input"></td>
            <td><div id="J_install_tip_dbname"></div></td>
          </tr>
          <tr>
            <td class="tar">数据库表前缀：</td>
            <td><input type="text" name="dbprefix" id="dbprefix" value="lvyecms_" class="input"></td>
            <td><div id="J_install_tip_dbprefix"><span class="gray">建议使用默认，同一数据库安装多个LvyeCMS时需修改</span></div></td>
          </tr>
        </table>
		<table width="100%">
          <tr>
          ...
          <tr>
            ...
            <td><input type="text" name="sitename" value="LvyeCMS内容管理系统" class="input"></td>
            <td><div id="J_install_tip_sitename"></div></td>
          </tr>
          <tr>
            <td class="tar">网站域名：</td>
            <td><input type="text" name="siteurl" value="{$parse_url.path}" id="siteurl" class="input" autoComplete="off"></td>
            <td><div id="J_install_tip_siteurl"><span class="gray">请以“/”结尾</span></div></td>
          </tr>
          <tr>
            <td class="tar">关键词：</td>
            <td><input type="text" name="sitekeywords" value="LvyeCMS内容管理系统" class="input" autoComplete="off"></td>
            <td><div id="J_install_tip_sitekeywords"></div></td>
          </tr>
          <tr>
            <td class="tar">描述：</td>
            <td><input type="text" name="siteinfo" class="input" value="LvyeCMS网站管理系统,是一款完全开源免费的PHP+MYSQL系统.核心采用了Thinkphp框架等众多开源软件,同时核心功能也作为开源软件发布"></td>
        ...
        <table width="100%">
		  ...
		  <tr>
            ...
            <td><input name="testdata" type="checkbox" value="1" alt="测试数据需要安装在根目录下才可以完整体验-__,-!" title="测试数据需要安装在根目录下才可以完整体验-__,-!"/><span class="gray">默认测试数据，了解LvyeCMS！</span></td>
            <td><div id="J_install_tip_manager_email"></div></td>
          </tr>
        </table>
        <div id="J_response_tips" style="display:none;"></div>
      </div>
      <div class="bottom tac"> <a href="{:U('step_2')}" class="btn">上一步</a>
