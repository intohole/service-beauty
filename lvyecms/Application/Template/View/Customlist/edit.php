      ...
      <table cellpadding="0" cellspacing="0" class="table_form" width="100%">
        <tbody>
          ...
          <tr>
            ...
            <span class="gray">如：select count(*) as total from lvyecms_article where catid = 1</span></td>
          </tr>
          <tr>
            ...
            <span class="gray">如：select * from lvyecms_article where catid = 1 order by id desc</span></td>
          </tr>
          <tr>
