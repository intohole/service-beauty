      ...
      <table width="100%" cellpadding="2" cellspacing="1" class="table_form">
        ...
        <tr>
          ...
          <td><select name='module' id='module'>
              ...
              <option value="{$r['module']}" <if condition="$data['module'] eq $r['module'] ">selected</if>>{$r['name']}</option>
              </volist>
            </select></td>
        </tr>
        <tr>
          <th>是否生成静态？ :</th>
          <td><input type="radio" value="1" name="ishtml" <if condition="$data['ishtml'] eq '1' "> checked</if>/>是 
          <input type="radio" value="0" name="ishtml" <if condition="$data['ishtml'] eq '0' "> checked</if>/>否 </td>
        </tr>
        <tr>
          <th>URL示例 :</th>
