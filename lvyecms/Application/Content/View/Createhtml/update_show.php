...
<div class="wrap ">
  ...
  <table width="100%" cellspacing="0">
      <form action="{:U("Content/Createhtml/update_show")}" method="post" name="myform">
...
<script language="JavaScript">
	function change_model(modelid) {
		window.location.href=GV.DIMAUB+'index.php?a=update_show&m=Createhtml&g=Content&modelid='+modelid;
	}
</script>
</body>
</html>