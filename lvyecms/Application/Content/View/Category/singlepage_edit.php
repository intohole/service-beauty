              ...
              <td><div class="user_group J_check_wrap">
                  ...
                  <volist name="Role_group" id="vo">
                    ...
                    <dd>
                      ...
                      <label><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid{$vo.id}" name="priv_roleid[]" <if condition=" $vo['id'] eq 1 "> disabled</if>     <?php echo D("Content/CategoryPriv")->check_category_priv($privs,'move',$vo['id'],1);?> value="move,{$vo.id}" ><span>移动</span></label>
                    </dd>
                   </volist>
                  </dl>
                </div></td>
