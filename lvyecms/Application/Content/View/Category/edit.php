      ...
      <div>
        ...
        <div class="table_full">
          <table width="100%" class="table_form ">
            ...
            <tr>
              <th>指定栏目地址：</th>
              <td><input type="text" name="setting[seturl]" id="seturl" class="input length_6" value="{$data['setting']['seturl']}"><span class="gray"> 指定地址后，栏目url将变成这个！</span></td>
            </tr>
          </table>
        </div>
      </div>
        ...
        <div class="table_full">
          <table width="100%" class="table_form ">
            ...
            <tr>
              ...
              <span class="gray">模板名称不带后缀，不设置为使用默认列表，增加列表模板可在/shuipf/Application/Content/View/Listtemplate/里增加文件</span></td>
            </tr>
          </table>
        </div>
      </div>
            ...
            <tr>
              ...
              <td><div class="user_group J_check_wrap">
                  ...
                  <volist name="Role_group" id="vo">
                    ...
                    <dd>
                      <label><input  class="J_check" type="checkbox" data-yid="J_check_priv_roleid{$vo.id}"  name="priv_roleid[]" <if condition=" $vo['id'] eq 1 "> disabled</if>   <?php echo D("Content/CategoryPriv")->check_category_priv($privs,'init',$vo['id'],1);?> value="init,{$vo.id}" ><span>查看</span></label>
                      <label><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid{$vo.id}" name="priv_roleid[]" <if condition=" $vo['id'] eq 1 "> disabled</if>     <?php echo D("Content/CategoryPriv")->check_category_priv($privs,'add',$vo['id'],1);?> value="add,{$vo.id}" ><span>添加</span></label>
                      <label><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid{$vo.id}" name="priv_roleid[]" <if condition=" $vo['id'] eq 1 "> disabled</if>     <?php echo D("Content/CategoryPriv")->check_category_priv($privs,'edit',$vo['id'],1);?> value="edit,{$vo.id}" ><span>修改</span></label>
                      <label><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid{$vo.id}" name="priv_roleid[]" <if condition=" $vo['id'] eq 1 "> disabled</if>     <?php echo D("Content/CategoryPriv")->check_category_priv($privs,'delete',$vo['id'],1);?> value="delete,{$vo.id}" ><span>删除</span></label>
                      <label><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid{$vo.id}" name="priv_roleid[]" <if condition=" $vo['id'] eq 1 "> disabled</if>     <?php echo D("Content/CategoryPriv")->check_category_priv($privs,'listorder',$vo['id'],1);?> value="listorder,{$vo.id}" ><span>排序</span></label>
                      <label><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid{$vo.id}" name="priv_roleid[]" <if condition=" $vo['id'] eq 1 "> disabled</if>     <?php echo D("Content/CategoryPriv")->check_category_priv($privs,'push',$vo['id'],1);?> value="push,{$vo.id}" ><span>推送</span></label>
                      <label><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid{$vo.id}" name="priv_roleid[]" <if condition=" $vo['id'] eq 1 "> disabled</if>     <?php echo D("Content/CategoryPriv")->check_category_priv($privs,'remove',$vo['id'],1);?> value="remove,{$vo.id}" ><span>移动</span></label>
                    </dd>
                   </volist>
                  </dl>
                </div></td>
            ...
            <tr>
              ...
              <td><div class="user_group J_check_wrap">
                  ...
                  <volist name="Member_group" id="vo">
                    ...
                    <dd>
                      <label><input  class="J_check" type="checkbox" data-yid="J_check_priv_groupid{$vo.groupid}"  name="priv_groupid[]" <if condition=" $vo['groupid'] eq 8 "> disabled</if> <?php echo D("Content/CategoryPriv")->check_category_priv($privs,'add',$vo['groupid'],0);?>  value="add,{$vo.groupid}" ><span>允许投稿</span></label>
                    </dd>
                   </volist>
                  </dl>
                </div></td>
        ...
        <volist name="extendList" id="vo">
         <tr>
          ...
          <switch name="vo.type">
             ...
             <case value="editor">
                 <script type="text/plain" id="extend_{$vo.fieldname}" name="extend[{$vo.fieldname}]">{$data['setting']['extend'][$vo['fieldname']]}</script>
                 <?php echo \Form::editor('extend_'.$vo['fieldname'], 'basic', MODULE_NAME); ?>
             </case>
          </switch>
