...
<div class="wrap J_check_wrap">
  <div class="nav">
    <ul class="cc">
      <li <if condition=" !isset($_GET['status']) ">class="current"</if>><a href="{:U('Content/classlist', array('catid'=>$catid)  )}">{$catname}列表（{$sum}条）</a></li>
      <li <if condition=" isset($_GET['status']) ">class="current"</if>><a href="{:U('Content/classlist', array('catid'=>$catid ,'search'=>1 ,'status'=>1)  )}">待审核文章（{$checkSum}条）</a></li>
    </ul>
  </div>
  <div class="mb10">
