  ...
  <table width="100%" height="100%" style="table-layout:fixed;">
    <tr class="head">
      ...
      <td><div class="nav"> 
        ...
        <div class="login_info"><span class="mr10">{$role_name}： {$userInfo.username}</span><a href="{:U('Public/logout')}" class="mr10">[注销]</a>{:tag("view_admin_top_menu")}<a href="{$Config.siteurl}" class="home" target="_blank">前台首页</a><a href="{$Config.addonsite}" class="home" target="_blank">开放平台</a><?php if(\Libs\System\RBAC::authenticate('Admin/Index/cache')){ ?><a href="javascript:;;" id="deletecache" class="home"  style="color:#FFF">缓存更新</a><?php } ?></div></td>
    </tr>
    <tr class="tab">
      <th> <div class="search">
          <input size="15" placeholder="Hi，LvyeCMS！" id="J_search_keyword" type="text">
