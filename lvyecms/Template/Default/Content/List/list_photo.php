...
<header id="header">
  <div class="top">
    <section class="logo">
      <hgroup>
        <h1> <a href="{$Config.siteurl}" title="水平凡" rel="home">水平凡个人博客</a> </h1>
      </hgroup>
  ...
  <nav class="menu-nav">
    <ul class="grid">
      ...
      <li class="g-u item cat book"> <a href="http://www.abc3210.com/2012/work_05/1.shtml"> <i class="img g-u png"></i>
